...
return [
    ...
    'accepter_tuteur' => [['id', 'id_notif'], ['_controller' => 'App\\Controller\\groupeController::accepterTuteur'], [], [['variable', '/', '[^/]++', 'id_notif', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/accepter_']], [], []],
    'refuser_tuteur' => [['id', 'id_notif'], ['_controller' => 'App\\Controller\\groupeController::refuserTuteur'], [], [['variable', '/', '[^/]++', 'id_notif', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/refuser_']], [], []],
