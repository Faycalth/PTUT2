...
return [
    ...
    'refuser_etudiant' => [['id', 'id_notif'], ['_controller' => 'App\\Controller\\groupeController::accepterGroupe'], [], [['variable', '/', '[^/]++', 'id_notif', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/groupe/accepter_groupe']], [], []],
