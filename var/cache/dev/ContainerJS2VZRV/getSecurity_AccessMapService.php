...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/groupe'), [0 => 'ROLE_ETUDIANT', 1 => 'ROLE_TUTEUR'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/etudiant'), [0 => 'ROLE_ETUDIANT'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/tuteur'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_TUTEUR'], NULL);
